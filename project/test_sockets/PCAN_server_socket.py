...
import os
import datetime
from module_declarations import MyDataFormat, SAMPLING_BASE_TIME, BYTE_N, CWD_PATH, SKT_PATH, SKT_PEAK, PEAK_MSGS,PEAKDataFormat
...
class PCANBasicExample(object):
    ...
    def loop(self):
        ...
        self.m_LastMsgsList = []
        while self.exit < 0:
            while (not (stsResult & PCAN_ERROR_QRCVEMPTY)) and (len(self.m_LastMsgsList) < PEAK_MSGS):
            ...
            response = ""
            for i in range(PEAK_MSGS):
                response = response+"{}{}".format(self.m_LastMsgsList[i][0],self.m_LastMsgsList[i][1])
            try:
                i = 0
    ...
    #     try:
    #         # Python2
    #         iter_a_dict = self.m_BAUDRATES.iteritems()
    #     except:
    #         # Python3
    #         iter_a_dict = self.m_BAUDRATES.items()
    #
    #     for name, value in iter_a_dict: self.cbbBaudrates.insert(Tix.END, name)
    ...
    #     try:
    #         # Python2
    #         iter_a_dict = self.m_HWTYPES.iteritems()
    #     except:
    #         # Python3
    #         iter_a_dict = self.m_HWTYPES.items()
    #     for name, value in iter_a_dict: self.cbbHwType.insert(Tix.END, name)
    ...
    #     try:
    #         # Python2
    #         iter_a_dict = self.m_IOPORTS.iteritems()
    #     except:
    #         # Python3
    #         iter_a_dict = self.m_IOPORTS.items()
    #     for name, value in iter_a_dict: self.cbbIO.insert(Tix.END, name)
    ...
    #     try:
    #         # Python2
    #         iter_a_dict = self.m_INTERRUPTS.iteritems()
    #     except:
    #         # Python3
    #         iter_a_dict = self.m_INTERRUPTS.items()
    #     for name, value in iter_a_dict: self.cbbInterrupt.insert(Tix.END, name)
    ...
    #     try:
    #         # Python2
    #         iter_a_dict = self.m_PARAMETERS.iteritems()
    #     except:
    #         # Python3
    #         iter_a_dict = self.m_PARAMETERS.items()
    #     for name, value in iter_a_dict: self.cbbParameter.insert(Tix.END, name)
